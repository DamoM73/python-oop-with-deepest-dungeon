...
So below is our student **class** with their respective **attributes** (blue) and **methods** (yellow). Think of it as a blueprint for all the examples of students that we will have in our program. *Every* student will have *all* the attributes and can access *all* the methods.
