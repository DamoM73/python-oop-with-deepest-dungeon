...
```{question} Make
Consider the additional character or characters that you have added, and change them into either a Friend, or an Enemy. 

Don't forget their weakness if they are an enemy.
```